...
// Para a representação de um polinomio, utilizamos uma lista encadeada
// sem cabeça, ordenada em ordem decrescente
#include<stdio.h>
#include<stdlib.h>
...
polinomio leia(){
    //nesse caso lemos o expoente e o coeficiente 
    // e o adicionamos a lista no lugar correto
    //mantendo a ordem decrescente
    int expoente;
    float coeficiente;
    Monomio *pr;
